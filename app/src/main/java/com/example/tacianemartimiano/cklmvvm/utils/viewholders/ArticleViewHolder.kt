...
class ArticleViewHolder(var view: View, val context: Context, private val listener: ArticleListener? = null) : RecyclerView.ViewHolder(view) {

    init {
        view.setOnClickListener {
            article?.let {
                listener?.onArticleClicked(it)
            }
        }
    }
